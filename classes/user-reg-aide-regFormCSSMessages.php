...
class URA_REG_FORM_CSS_OPTIONS
{
	...
	*/
	...
	function csds_userRegAide_regFormCSSOptions(){
		...
		if($csds_userRegAide_Options['csds_userRegAide_db_Version'] != "1.3.7.3"){
		...
		echo '<div id="wpbody">';
			echo '<div class=wrap>';
			do_action('create_tabs', 'registration_form_css_options'); // Line 255 user-registration-aide.php
				echo '<form method="post" name="csds_userRegAide">';
					...
					?>
				<div class="stuffbox"><span class="regForm"><?php _e('Add Your Own Custom Message to Top of Login & Registration Forms:', 'csds_userRegAide');?> </span>
					<div class="inside">
					...
					<tr>
						...
						if ($csds_userRegAide_Options['show_login_message'] == 1) echo 'checked' ;?>/> <?php _e('Yes', 'csds_userRegAide'); ?></span>
						...
						if ($csds_userRegAide_Options['show_login_message'] == 2) echo 'checked' ;?>/> <?php _e('No', 'csds_userRegAide'); ?> </span></td></tr>
					<tr>						
						<td width="40%"><?php _e('Enter new Login form message for top of login form here: ', 'csds_userRegAide');?></td>
						<td width="60%"><textarea name="csds_RegFormTopLogin_Message" id="csds_RegFormTopLogin_Message" class="regForm" rows="1" 
						title="<?php _e('Enter a custom message here for top of login form!', 'csds_userRegAide');?>"><?php _e(esc_textarea(stripslashes($csds_userRegAide_Options['login_message']),'csds_userRegAide'));?></textarea>
						</td>
					</tr>
					<tr>
						<td width="40%"><?php _e('Enter new Registration form message for top of page here: ', 'csds_userRegAide');?></td>
						<td width="60%"><textarea name="csds_RegFormTopRegistration_Message" id="csds_RegFormTopLogin_Message" class="regForm" rows="1" 
						title="<?php _e('Enter a custom message here for top of registration form!', 'csds_userRegAide');?>"><?php _e(esc_textarea(stripslashes($csds_userRegAide_Options['reg_top_message']),'csds_userRegAide'));?></textarea>
						</td>
					</tr>
					<tr>
						<td width="40%"><?php _e('Enter additional new Login form message for top of login page here: ', 'csds_userRegAide');?></td>
						<td width="60%"><textarea name="csds_LoginFormLogin_Message" id="csds_LoginFormLogin_Message" class="regForm" rows="1" 
						title="<?php _e('Enter an additional new custom message here for top of login form!', 'csds_userRegAide');?>"><?php _e(esc_textarea(stripslashes($csds_userRegAide_Options['login_messages_login']),'csds_userRegAide'));?></textarea>
						</td>
					</tr>
					<tr>
						<td width="40%"><?php _e('Enter new Login form message for top of login page when users log out here: ', 'csds_userRegAide');?></td>
						<td width="60%"><textarea name="csds_LoginFormLoggedOut_Message" id="csds_LoginFormLoggedOut_Message" class="regForm" rows="1" 
						title="<?php _e('Enter a custom message here for top of login form after user is logged out!', 'csds_userRegAide');?>"><?php _e(esc_textarea(stripslashes($csds_userRegAide_Options['login_messages_logged_out']),'csds_userRegAide'));?></textarea>
						</td>
					</tr>
					<tr>
						<td width="40%"><?php _e('Enter new Login Form message for top of Login Page after user succesfully registers here: ', 'csds_userRegAide');?></td>
						<td width="60%"><textarea name="csds_LoginFormRegisteredSuccess_Message" id="csds_LoginFormRegisteredSuccess_Message" class="regForm" rows="1" 
						title="<?php _e('Enter a custom message here for top of login form after user has succesfully registered!', 'csds_userRegAide');?>"><?php _e(esc_textarea(stripslashes($csds_userRegAide_Options['login_messages_registered']),'csds_userRegAide'));?></textarea>
						</td>
					</tr>
					<tr>
						<td width="40%"><?php _e('Enter new Lost Password Form message for top of Lost Password Page Here: ', 'csds_userRegAide');?></td>
						<td width="60%"><textarea name="csds_LostPassword_Message" id="csds_LostPassword_Message" class="regForm" rows="1" 
						title="<?php _e('Enter a custom message here for top of lost password form if user attempts to recover lost password!', 'csds_userRegAide');?>"><?php _e(esc_textarea(stripslashes($csds_userRegAide_Options['login_messages_lost_password']),'csds_userRegAide'));?></textarea>
						</td>
					</tr>
					</table>
					<div class="submit"><input type="submit" class="button-primary" name="reg_form_login_message_update" value="<?php _e('Update Top Registration Form Message Options', 'csds_userRegAide'); ?>"  /></div>
					</div>
				</div>
				...
				<?php	// Form area for adding custom logo ?>
					...
					<?php
						...
						<?php if ($csds_userRegAide_Options['show_logo'] == 1) echo 'checked' ;?>/> <?php _e('Yes', 'csds_userRegAide'); ?></span>
						...
						if ($csds_userRegAide_Options['show_logo'] == 2) echo 'checked' ;?>/> <?php _e('No', 'csds_userRegAide'); ?></span>
						</td>
						...
						if ($csds_userRegAide_Options['change_logo_link'] == 1) echo 'checked' ;?>/> <?php _e('Yes', 'csds_userRegAide'); ?></span>
						...
						if ($csds_userRegAide_Options['show_background_image'] == 1) echo 'checked' ;?> /> <?php _e('Yes', 'csds_userRegAide'); ?></span>
						...
						<?php if ($csds_userRegAide_Options['show_reg_form_page_image'] == 1) echo 'checked';?>/> <?php _e('Yes', 'csds_userRegAide'); ?></span>
						...
						<?php if ($csds_userRegAide_Options['show_background_color'] == 1) echo 'checked';?>/> <?php _e('Yes', 'csds_userRegAide'); ?></span>
						...
						<?php if ($csds_userRegAide_Options['show_background_color'] == 2) echo 'checked' ;?>/> <?php _e('No', 'csds_userRegAide'); ?></span>
						</td>
						<td colspan="2"><?php _e('New Background Color: ', 'csds_userRegAide');?>
						<input  style="width: 150px;" type="text" title="<?php _e(esc_attr('Enter the new background color for your login/register form (#FFFFFF)'), 'csds_userRegAide');?>" value="<?php _e(esc_attr($csds_userRegAide_Options['reg_background_color']), 'csds_userRegAide');?>" name="csds_userRegAide_newBackgroundColor" id="csds_userRegAide_newBackgroundColor" />
						</td>
						</tr>
						<?php
						...
						<?php if ($csds_userRegAide_Options['show_reg_form_page_color'] == 1) echo 'checked';?>/> <?php _e('Yes', 'csds_userRegAide'); ?></span>
						...
						<?php if ($csds_userRegAide_Options['show_reg_form_page_color'] == 2) echo 'checked' ;?>/> <?php _e('No', 'csds_userRegAide'); ?></span>
						</td>
						<td colspan="2"><?php _e('New Page Background Color: ', 'csds_userRegAide');?>
						<input  style="width: 150px;" type="text" title="<?php _e(esc_attr('Enter the new page background color for your register/login form (#FFFFFF)'), 'csds_userRegAide');?>" value="<?php _e(esc_attr($csds_userRegAide_Options['reg_form_page_color']), 'csds_userRegAide');?>" name="csds_userRegAide_newPageBackgroundColor" id="csds_userRegAide_newPageBackgroundColor" /></td></tr>
						<?php
						...
						<?php if ($csds_userRegAide_Options['show_login_text_color'] == 1) echo 'checked';?>/> <?php _e('Yes', 'csds_userRegAide'); ?></span>
						...
						<?php if ($csds_userRegAide_Options['show_login_text_color'] == 2) echo 'checked' ;?>/> <?php _e('No', 'csds_userRegAide'); ?></span>
						</td>
						<td><?php _e('New Text/Links Color: ', 'csds_userRegAide');?>
						<input  style="width: 100px;" type="text" title="<?php _e(esc_attr('Enter the new text/links color for your site (#FFFFFF)'), 'csds_userRegAide');?>" value="<?php _e(esc_attr($csds_userRegAide_Options['login_text_color']), 'csds_userRegAide');?>" name="csds_userRegAide_newTextColor" id="csds_userRegAide_newTextColor" /></td>
						<td><?php _e('New Links Hover Color: ', 'csds_userRegAide');?>
						<input  style="width: 100px;" type="text" title="<?php _e(esc_attr('Enter the new hover color for your login page links (#FFFFFF)'), 'csds_userRegAide');?>" value="<?php _e(stripslashes($csds_userRegAide_Options['hover_text_color']), 'csds_userRegAide');?>" name="csds_userRegAide_newHoverTextColor" id="csds_userRegAide_newHoverTextColor" />
						</td>
						</tr>
						<?php
						...
						<?php if ($csds_userRegAide_Options['show_shadow'] == 1) echo 'checked';?>/> <?php _e('Yes', 'csds_userRegAide'); ?></span>
						...
						<?php if ($csds_userRegAide_Options['show_shadow'] == 2) echo 'checked' ;?>/> <?php _e('No', 'csds_userRegAide'); ?>
						</td>
						<td><?php _e('Shadow Size in PX: ', 'csds_userRegAide');?>
						<input  style="width: 100px;" type="text" title="<?php _e(esc_attr('Enter the new size of shadow for login/registration page links in PX for your site! Example: 2px'), 'csds_userRegAide');?>" value="<?php _e(esc_attr($csds_userRegAide_Options['shadow_size']), 'csds_userRegAide');?>" name="csds_userRegAide_shadowSize" id="csds_userRegAide_newTextColor" /></td>
						<td><?php _e('Shadow Color: ', 'csds_userRegAide');?>
						<input  style="width: 100px;" type="text" title="<?php _e(esc_attr('Enter the new color for your login page links shadows (#FFFFFF)'), 'csds_userRegAide');?>" value="<?php _e(esc_attr($csds_userRegAide_Options['shadow_color']), 'csds_userRegAide');?>" name="csds_userRegAide_shadowColor" id="csds_userRegAide_shadowColor" />
						</td>
						</tr>
						</table>
						<div class="submit"><input type="submit" class="button-primary" name="csds_userRegAide_logo_update" id="csds_userRegAide_logo_update" value="<?php _e('Update Login-Reg Form Style Options', 'csds_userRegAide');?>" /></div>
						</div>
					</div>
					<?php
